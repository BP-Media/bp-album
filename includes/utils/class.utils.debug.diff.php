 ...
 * @license MIT License
 *
 * Adapted from @link http://raymondhill.net/blog/?p=441
 *
 * ========================================================================================================
 */
...
class FineDiff {
	...
	public static $sentenceGranularity = array( FineDiff::paragraphDelimiters,
						    FineDiff::sentenceDelimiters
						);

	public static $wordGranularity = array(	FineDiff::paragraphDelimiters,
						FineDiff::sentenceDelimiters,
						FineDiff::wordDelimiters
					    );

	public static $characterGranularity = array(	FineDiff::paragraphDelimiters,
							FineDiff::sentenceDelimiters,
							FineDiff::wordDelimiters,
